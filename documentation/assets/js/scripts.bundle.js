...
jquery__WEBPACK_IMPORTED_MODULE_1__(document).ready(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_1__(window).on('beforeunload unload load', function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_1__(this).scrollTop() > 80) {
      jquery__WEBPACK_IMPORTED_MODULE_1__('.js-navbar').addClass('scrolled');
    }else{
      jquery__WEBPACK_IMPORTED_MODULE_1__('.js-navbar').removeClass('scrolled');
    }
  });

  jquery__WEBPACK_IMPORTED_MODULE_1__(window).bind('scroll load', function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_1__(this).scrollTop() > 80) {
      jquery__WEBPACK_IMPORTED_MODULE_1__('.js-navbar').addClass('scrolled');
    }else{
      jquery__WEBPACK_IMPORTED_MODULE_1__('.js-navbar').removeClass('scrolled');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_1__('.js-navbar__menu').on('click', function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_1__(this).hasClass("active")) {
      jquery__WEBPACK_IMPORTED_MODULE_1__('.js-navbar').removeClass('active');
      jquery__WEBPACK_IMPORTED_MODULE_1__('.js-navbar-mobile').removeClass('active');
      jquery__WEBPACK_IMPORTED_MODULE_1__('.navbar__menu--menu').removeClass('d-none');
      jquery__WEBPACK_IMPORTED_MODULE_1__('.navbar__menu--menu').addClass('d-block');
      jquery__WEBPACK_IMPORTED_MODULE_1__('.navbar__menu--close').removeClass('d-block');
      jquery__WEBPACK_IMPORTED_MODULE_1__('.navbar__menu--close').addClass('d-none');
      jquery__WEBPACK_IMPORTED_MODULE_1__(this).removeClass('active');
      e.preventDefault();
      e.stopPropagation();
    }else{
      jquery__WEBPACK_IMPORTED_MODULE_1__(this).addClass('active');
      jquery__WEBPACK_IMPORTED_MODULE_1__('.js-navbar').addClass('active');
      jquery__WEBPACK_IMPORTED_MODULE_1__('.js-navbar-mobile').addClass('active');
      jquery__WEBPACK_IMPORTED_MODULE_1__('.navbar__menu--menu').removeClass('d-block');
      jquery__WEBPACK_IMPORTED_MODULE_1__('.navbar__menu--menu').addClass('d-none');
      jquery__WEBPACK_IMPORTED_MODULE_1__('.navbar__menu--close').removeClass('d-none');
      jquery__WEBPACK_IMPORTED_MODULE_1__('.navbar__menu--close').addClass('d-block');
      e.preventDefault();
      e.stopPropagation();
    }
  });
